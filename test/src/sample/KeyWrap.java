...
public class KeyWrap {
    ...
    public static byte[] Wrap(File file)  {
        ...
        try {
            ...
            Main.KeyPathToWrap = file.getPath();
            ...
            byte[] SymmKey = FileUtils.readAllBytes(  Main.KeyPathToWrap);
            ...
            FileUtils.write(Main.KeyPathToWrap, WrapEncoded);
            Main.text[1].setFill(Color.GREEN);

            Main.text[0].setFill(Color.ORANGERED);

            Main.text[1].setText("Key filepath " + Main.KeyPathToWrap);
    ...
    public static SecretKey UnWrap(File file) {
        ...
        Main.KeyPathToWrap = file.getPath();
            PrivateKey privateKey = KeyPairs.getPrivateKey();
            byte[] SymmKey = FileUtils.readAllBytes(Main.KeyPathToWrap);
        ...
        FileUtils.write(Main.KeyPathToWrap,
                UnWrapEncoded);
